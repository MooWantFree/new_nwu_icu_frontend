<template>
    <div class="flex min-h-[80dvh] flex-col items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-md text-center">
        ...
        <template v-else-if="success">
          ...
          <h1 class="mt-4 text-3xl font-bold tracking-tight text-foreground">邮箱验证成功</h1>
        ...
        <template v-else>
          ...
          <h1 class="mt-4 text-3xl font-bold tracking-tight text-foreground">验证失败</h1>
          <p class="mt-4 text-muted-foreground">
            {{ error }}
          </p>
          <div class="mt-6">
