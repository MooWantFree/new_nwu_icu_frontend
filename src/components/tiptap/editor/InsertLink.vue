    ...
    <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div class="relative w-full max-w-md p-6 bg-white rounded-lg shadow-xl">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div>
            <label for="linkUrl" class="block mb-1 text-sm font-medium text-gray-700">URL</label>
            <input
              id="linkUrl"
              v-model="url"
              type="url"
          ...
          <div>
            <label for="linkText" class="block mb-1 text-sm font-medium text-gray-700">Link Text</label>
            <input
              id="linkText"
              v-model="text"
              type="text"
