    ...
    <div class="bg-white p-6 rounded-lg shadow-xl w-96">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <input v-model="imageUrl" type="url" placeholder="https://example.com/image.jpg" class="w-full border p-2 rounded">
        </div>
        <div class="flex justify-end space-x-2">
          <button @click="closeModal" class="px-4 py-2 bg-gray-200 rounded" :disabled="loading">取消</button>
          <button @click="submitImage" class="px-4 py-2 bg-blue-500 text-white rounded flex items-center justify-center" :disabled="loading">
...
const { loading, succeed, imageUrl: uploadedImageUrl, message, uploadFile, errors } = useFileUpload()
