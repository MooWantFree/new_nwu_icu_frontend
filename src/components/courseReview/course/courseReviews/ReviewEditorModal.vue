  ...
  <div
    ...
    <div class="relative w-full max-w-3xl mx-auto my-6 px-4 sm:px-0">
      <div
        ...
        <div v-if="!loading" class="relative p-4 sm:p-6 flex-auto overflow-y-auto">
          <n-collapse>
        ...
        <div
          ...
          <button
            ...
            type="button" @click="closeModal" :disabled="submitting || loading">
            关闭
          </button>
          <button
            ...
            type="button" @click="submitReview" :disabled="submitting || loading">
